...
This file is now mainly a **historical planning document**. For current upstream
comparison and remaining parity gaps, use `docs/OPENCODE_INTEGRATION_PARITY.md`.
For current release gating, use `docs/release-checklist.md`.
